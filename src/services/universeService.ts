...
function parseUniverseAsset(value: unknown): UniverseAsset {
  ...
  return {
    ...
    issuer: optionalString(asset.issuer),
    fundCode: optionalString(asset.fundCode),
    fundTaxId: optionalString(asset.fundTaxId),
    fundTypeCode: optionalString(asset.fundTypeCode),
    beneficiaryCertificateCode: optionalString(asset.beneficiaryCertificateCode),
