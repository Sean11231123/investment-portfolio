...
export function Dashboard({
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      {valuation.isPartial ? (
        <section className="rounded-[1.75rem] border border-[var(--app-warning-bg)] bg-[var(--app-warning-bg)] px-4 py-3 text-sm leading-6 text-[var(--app-warning-text)]">
      ...
      <section className="grid grid-cols-1 gap-3 sm:flex sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-semibold text-[var(--app-text)]">價格與資料</p>
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-semibold text-[var(--app-text)]">投組配置</h2>
      ...
      <div className="space-y-1">
        <h2 className="text-lg font-semibold text-[var(--app-text)]">ETF 展開摘要</h2>
        <p className="text-sm leading-6 text-[var(--app-text-muted)]">
