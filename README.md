...
- Export and import v2 JSON backups, with v1 MVP import migration.
...
Use the holdings page import/export controls:

- Export downloads a v2 backup object with `version`, `exportedAt`, `holdings`, and optional `settings`.
- Import accepts v2 backups.
